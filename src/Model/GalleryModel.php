 ...
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findByPid($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findByTstamp($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findByTitle($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findByAlias($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findByAuthor($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findByStartDate($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findByEndDate($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findByImages($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findByPreviewImage($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findByEvent($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findByPlace($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findByPhotographer($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findByDescription($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findByMetaTitle($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findByRobots($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findByMetaDescription($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findByCssClass($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findByFeatured($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findByPublished($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findByStart($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findByStop($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findMultipleByIds($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findBy($col, $val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryModel|null findAll(array $opt = [])
