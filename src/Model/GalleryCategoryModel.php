 ...
 * @method static Collection|GalleryCategoryModel[]|GalleryCategoryModel|null findByTstamp($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryCategoryModel|null findByTitle($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryCategoryModel|null findByJumpTo($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryCategoryModel|null findByProtected($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryCategoryModel|null findByGroups($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryCategoryModel|null findMultipleByIds($val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryCategoryModel|null findBy($col, $val, array $opt = [])
 * @method static Collection|GalleryCategoryModel[]|GalleryCategoryModel|null findAll(array $opt = [])
